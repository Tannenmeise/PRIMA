...
(function (L13_Doom_UIb) {
    ...
    })(ANGLE = L13_Doom_UIb.ANGLE || (L13_Doom_UIb.ANGLE = {}));
    let JOB;
    (function (JOB) {
        JOB[JOB["IDLE"] = 0] = "IDLE";
        JOB[JOB["PATROL"] = 1] = "PATROL";
    })(JOB = L13_Doom_UIb.JOB || (L13_Doom_UIb.JOB = {}));
    class Enemy extends f.Node {
        constructor(_name = "Enemy", _position) {
            ...
            let cmpStateMachine = new L13_Doom_UIb.ComponentStateMachineEnemy();
        ...
        update() {
            this.getComponent(L13_Doom_UIb.ComponentStateMachineEnemy).act();
        ...
        chooseTargetPosition() {
            let range = L13_Doom_UIb.sizeWall * L13_Doom_UIb.numWalls / 2 - 2;
        ...
        displayAnimation() {
            this.show.mtxLocal.showTo(f.Vector3.TRANSFORMATION(L13_Doom_UIb.avatar.mtxLocal.translation, this.mtxWorldInverse, true));
