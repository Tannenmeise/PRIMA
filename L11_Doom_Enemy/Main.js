...
(function (L11_Doom_Enemy) {
    ...
    async function createEnemies() {
        ...
        enemies.appendChild(new L11_Doom_Enemy.Enemy("Cacodemon0", f.Vector3.Z(3)));
        enemies.appendChild(new L11_Doom_Enemy.Enemy("Cacodemon1", f.Vector3.X(3)));
        enemies.appendChild(new L11_Doom_Enemy.Enemy("Cacodemon2", f.Vector3.X(-3)));
